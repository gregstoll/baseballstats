    ...
    for line in f.readlines():
        ...
        if lineMatch:
            ...
            if (lineMatch.group(6) == '1'):
                baseSum = baseSum + 4
            stringToPrint = stringToPrint + "%s,%s,%s,%s,%s,%s,%s,%s" % (lineMatch.group(1), lineMatch.group(3), baseSum, lineMatch.group(7), lineMatch.group(8), lineMatch.group(9), lineMatch.group(11), lineMatch.group(10))
